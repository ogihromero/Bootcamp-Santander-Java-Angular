  ...
  pokeApi.getPokemonDetailById(id).then((detail) => {
    ...
    aboutPoke.innerHTML += `
        <main id="about">
            ...
            <dd class="bar">
                <progress class="progress-bar" max="200" value="${detail.hp}">${
      detail.hp
    }</progress>
            </dd>
            ...
            <dd class="bar">
                <progress class="progress-bar" max="200" value="${
                  detail.attack
                }">${detail.attack}</progress>
            </dd>
            ...
            <dd class="bar">
                <progress class="progress-bar" max="200" value="${
                  detail.speed
                }">${detail.speed}</progress>
            </dd>
    
            <dt class="ability">Total (${detail.total})</dt>
            <dd class="bar">
                <progress class="progress-bar" max="700" value="${
                  detail.total
                }">${detail.total}</progress>
            </dd>
                    </dl>
            </section>
